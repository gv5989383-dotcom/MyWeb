...
function videoResultHTML(data, r) {
    ...
    return `<div class="result-box">
        ...
        <div class="metrics-row">
            <div class="m-item"><span class="m-num">${data.total_faces}</span><span class="m-txt">Total Frames</span></div>
            <div class="m-item"><span class="m-num" style="color:var(--red)">${data.fake_count}</span><span class="m-txt">Anomalies</span></div>
            <div class="m-item"><span class="m-num" style="color:var(--green)">${data.real_count}</span><span class="m-txt">Authentic</span></div>
        ...
        <div class="forensic-box">
            <h4><i class="fas fa-microscope"></i> Forensic Analysis (Temporal)</h4>
            <div class="f-item"><span>Edge Integrity</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[0]}%</span></div>
            <div class="f-item"><span>Landmark Continuity</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[1]}%</span></div>
            <div class="f-item"><span>Geometric Symmetry</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[2]}%</span></div>
            <div class="f-item"><span>Surface Sharpness</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[3]}%</span></div>
            <div class="f-item"><span>Temporal Stability</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[4]}%</span></div>
        </div>
...
<div class="forensic-box"><h4><i class="fas fa-microscope"></i> Forensic Analysis</h4><div class="f-item"><span>Edge Integrity</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[0]}%</span></div><div class="f-item"><span>Landmark Continuity</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[1]}%</span></div><div class="f-item"><span>Geometric Symmetry</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[2]}%</span></div><div class="f-item"><span>Surface Sharpness</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[3]}%</span></div><div class="f-item"><span>Transformation Stability</span><div class="f-bar"><div class="f-fill"></div></div><span class="f-pct">${r.factors[4]}%</span></div></div><div class="result-actions"><button class="btn-primary" onclick="window.location.href='/download-report'"><i class="fas fa-download"></i> Download Report</button><button class="btn-secondary" onclick="resetCurrent()"><i class="fas fa-redo"></i> New Analysis</button></div></div>`}
